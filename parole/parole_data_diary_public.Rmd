...
Those could be data entry errors. We decide to still include them in the data and count absence rate accordingly. So we first create a column `none`.
...
Then we need to get rid of empty rows. Also sometimes there're records with no motion recorded but votes recorded. 
